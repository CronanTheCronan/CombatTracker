...
namespace CombatTracker.Repos
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public async Task<Users> Login(string username, string password)
        {
            ...
            var passwordHashByteArray = user.PasswordHash;
            var passwordSaltByteArray = user.PasswordSalt;

            if (user == null)
                return null;

            if (!VerifyPasswordHash(password, passwordHashByteArray, passwordSaltByteArray))
                return null;
